        ...
        if (currentItems.isEmpty()) {
            val sampleItems = listOf(
                CollectibleItem(
                    ...
                    category = CollectibleCategory.CARDS.name,
                ...
                CollectibleItem(
                    ...
                    category = CollectibleCategory.WATCHES.name,
                ...
                CollectibleItem(
                    ...
                    category = CollectibleCategory.COMICS.name,
                ...
                CollectibleItem(
                    ...
                    category = CollectibleCategory.SNEAKERS.name,
                ...
                CollectibleItem(
                    title = "1907 Saint-Gaudens Double Eagle $20 Gold Coin",
                    category = CollectibleCategory.COINS.name,
                    description = "High relief wire rim gold coin. PCGS certified strike.",
                    ownerName = "Apex Numismatics",
                    ownerRating = 4.98f,
                    estimatedValueUsd = 22000.0,
                    conditionGrade = "PCGS MS-65 High Relief",
                    authenticityScore = 100,
                    vaultHashId = "VAULT-8842-1200-2026",
                    isListedForSale = false,
                    salePriceUsd = 0.0,
                    imageType = "COIN"
                )
